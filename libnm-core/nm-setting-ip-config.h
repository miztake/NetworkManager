...
guint         nm_setting_ip_config_get_num_dhcp_reject_servers        (NMSettingIPConfig *setting);
NM_AVAILABLE_IN_1_28
const char   *nm_setting_ip_config_get_dhcp_reject_server             (NMSettingIPConfig *setting,
                                                                       int                 idx);
NM_AVAILABLE_IN_1_28
gboolean      nm_setting_ip_config_add_dhcp_reject_server             (NMSettingIPConfig *setting,
                                                                       const char        *server);
NM_AVAILABLE_IN_1_28
void          nm_setting_ip_config_remove_dhcp_reject_server          (NMSettingIPConfig *setting,
                                                                       int                idx);
NM_AVAILABLE_IN_1_28
gboolean      nm_setting_ip_config_remove_dhcp_reject_server_by_value (NMSettingIPConfig *setting,
                                                                       const char        *server);
NM_AVAILABLE_IN_1_28
