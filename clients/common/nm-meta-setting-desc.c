	...
	PROPERTY_INFO (NM_SETTING_IP_CONFIG_DHCP_REJECT_SERVERS, DESCRIBE_DOC_NM_SETTING_IP4_CONFIG_DHCP_REJECT_SERVERS,
	    ...
	    .property_typ_data = DEFINE_PROPERTY_TYP_DATA (
	        PROPERTY_TYP_DATA_SUBTYPE (multilist,
	            ...
	            .add_fcn =              MULTILIST_ADD_FCN             (NMSettingIPConfig, nm_setting_ip_config_add_dhcp_reject_server),
	            .remove_by_idx_fcn_s =  MULTILIST_REMOVE_BY_IDX_FCN_S (NMSettingIPConfig, nm_setting_ip_config_remove_dhcp_reject_server),
